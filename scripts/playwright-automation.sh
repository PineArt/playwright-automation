...
[pw-auto] commands:
[pw-auto]   probe network --session <name> [--name <label>] [--duration-ms 5000] [--until-quiet-ms <ms>] [--include <substring>] [--exclude <substring>] [--regex] [--reload|--goto <url>|--click <selector>|--select <selector> --value <value>] [--wait-until load|domcontentloaded|networkidle|commit] [--include-bodies] [--body-max-chars 2048]
...
[pw-auto]   probe style --session <name> --selector <selector> --property <css-name> [--property <css-name> ...] [--name <label>] [--text-max-chars 120]
[pw-auto] notes:
