    ...
    switch ($CommandName) {
        ...
        "probe" {
            $lines = @(
                ...
                "[pw-auto] commands:",
                "[pw-auto]   probe network --session <name> [--name <label>] [--duration-ms 5000] [--until-quiet-ms <ms>] [--include <substring>] [--exclude <substring>] [--regex] [--reload|--goto <url>|--click <selector>|--select <selector> --value <value>] [--include-bodies] [--body-max-chars 2048]",
